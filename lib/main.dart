...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SafeArea(
        // child:hasToken? HomeScreen(): LoginScreen(),
        child: LoginScreen(),
        ),
      // MyHomePage(),
    );
...
void showSnackBar(BuildContext context, String message) {
  ...
  scaffoldMessenger.showSnackBar(
     SnackBar(
      ...
      duration:const Duration(seconds: 8), // Optional: Set the duration
    ),
  );
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PdfPreview(
        ...
        // onPrinted: (context) => print('successful'),
        // showSnackBar(context, 'Successful'),
        // onPrintError: (context, error) => print(error),
